...
**Prerequisites:** The engine targets PHP 8.5. The public Docker image
is built on `php:8.5-cli` and bundles a lightweight Markdown/frontmatter
parser, so you don't need extra composer or npm dependencies locally.
